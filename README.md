...
* **黑胶市场查价**：精准锁定黑胶唱片版本，实时获取 Discogs 市场上的在售数量与最低起售价（美元）。
...
本插件依赖 Discogs 官方的 API Token，如果不配置 Token，搜索功能将无法使用。

### 获取 Discogs Token
1. 注册或登录 [Discogs 官网](https://www.discogs.com/)。
...
3. 将刚才复制的 Token 粘贴进去并保存设置，重启或重载插件即可。
...
本插件支持 Discogs 的高级搜索维度过滤。你可以通过 `维度:值` 的格式来缩小搜索范围。
...
* `/黑胶价格 genre:jazz year:1959` (查找 1959 年的爵士乐黑胶)
